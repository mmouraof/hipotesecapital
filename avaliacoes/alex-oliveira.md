...
1. Chaves de API sao placeholders (nao funcionais)
2. MySQL obrigatorio sem alternativa
3. WeasyPrint requer bibliotecas nativas GTK (falha em Windows)
4. Cadeia de imports impede importacao de qualquer modulo
5. 133 dependencias incluindo pacotes nao utilizados (Django, Selenium, LangChain)
